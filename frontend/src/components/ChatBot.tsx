/**
 * ChatBot Component
 * A floating chat assistant that helps users discover courses and domains.
 * Responds to questions about pricing, courses, domains, and instructors.
 */
...
const ChatBot: React.FC = () => {
  ...
  // Domain-specific video recommendations
